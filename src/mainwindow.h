...
class MainWindow : public QMainWindow{
    ...
    private:
        ...
        int game_timer=0;
        int nb_min=0;
        std::string w_path=std::string("D:/Copie_cle_MathWorks/A_recup_sur_ma_cle/IMDS4A/Tetris/V4/Save/save.txt");
        QUrl w_s_path = QUrl(QString::fromStdString(std::string("D:/Copie_cle_MathWorks/A_recup_sur_ma_cle/IMDS4A/Tetris/V4/Sound/Tetris_theme.m4a")));
        QUrl w_s_m_path = QUrl(QString::fromStdString(std::string("D:/Copie_cle_MathWorks/A_recup_sur_ma_cle/IMDS4A/Tetris/V4/Sound/Menu_theme.mp3")));
