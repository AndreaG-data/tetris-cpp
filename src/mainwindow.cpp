...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow){
    ...
    menu_background.load("D:/Copie_cle_MathWorks/A_recup_sur_ma_cle/IMDS4A/Tetris/V4/Image/Menu_background.png");
    game_background.load("D:/Copie_cle_MathWorks/A_recup_sur_ma_cle/IMDS4A/Tetris/V4/Image/play_background.jpg");
    lose_background.load("D:/Copie_cle_MathWorks/A_recup_sur_ma_cle/IMDS4A/Tetris/V4/Image/Lose_background.jpg");
